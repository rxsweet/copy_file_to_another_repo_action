...
#git clone --single-branch --branch $INPUT_DESTINATION_BRANCH "https://x-access-token:${{secrets.UPDATE_REPO}}@$INPUT_GIT_SERVER/$INPUT_DESTINATION_REPO.git" "$CLONE_DIR"
